...
const MyAppointments = () => {
  ...
  return (
    <div>
      ...
      <div className='h-[80vh] overflow-y-scroll items-start'>
        {
          appointments.map((item, index) => (
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <label className='text-zinc-700 font-medium mt-1'>Address</label>
              ...
              <div className='flex flex-col gap-2 justify-end'>
                ...
                {!item.cancelled && item.payment && !item.isCompleted && <button className='sm:min-w-48 py-2 border bg-indigo-50 rounded text-stone-500'>Paid</button>}
